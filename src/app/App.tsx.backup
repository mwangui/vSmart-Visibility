import svgPaths from "./svg-xu79yoskty";
import imgHeader from "./73ec653e128edda67501b4df083e58e8150cd4b3.png";
import { imgWarningBorder, imgWarningBorder1 } from "./svg-w8riy";
    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-center min-w-px relative" data-name="Left">
      <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="Breadcrumbs">
        <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name=".Breadcrumb text">
          <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#656c75] text-[14px] whitespace-nowrap">Devices</p>
        </div>
        <div className="relative shrink-0 size-[12px]" data-name="CaretRight">
          <div className="absolute inset-[14.06%_26.56%_14.06%_32.81%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.875 8.625">
              <path clipRule="evenodd" d={svgPaths.p162cd760} fill="var(--fill-0, #7E868F)" fillRule="evenodd" id="Vector" />
            </svg>
          </div>
        </div>
        <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name=".Breadcrumb text">
          <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#656c75] text-[14px] whitespace-nowrap">Logs</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-end justify-center min-w-px relative" data-name="Right content">
      <div className="content-stretch flex items-center justify-center relative rounded-[6px] shrink-0" data-name=".⚠ / Button">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#1d69cc] text-[14px] whitespace-nowrap">View old version</p>
      </div>
    </div>
  );
}
...
function Left1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[399px]" data-name="Left">
      <p className="font-['Sharp_Sans:Bold',sans-serif] leading-[34px] not-italic relative shrink-0 text-[#373c42] text-[24px] whitespace-nowrap">Devices</p>
      <div className="flex flex-row items-center self-stretch">
        <div className="content-stretch flex h-full items-center relative shrink-0" data-name=".Filters">
          <div className="content-stretch flex items-start relative shrink-0" data-name=".⚠ / Single Select">
            <div className="bg-white content-stretch flex gap-[8px] items-center px-[8px] py-[5px] relative rounded-[6px] shrink-0" data-name=".⚠ / Input field without label">
              <div aria-hidden="true" className="absolute border-2 border-[#889099] border-solid inset-0 pointer-events-none rounded-[6px]" />
              <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[18px] min-w-px not-italic relative text-[#23282e] text-[12px]">CG113-SDRA</p>
              <div className="relative shrink-0 size-[14px]" data-name="DropdownCaretDown">
                <div className="absolute inset-[36.72%_22.66%_30.47%_22.66%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.65625 4.59375">
                    <path clipRule="evenodd" d={svgPaths.p3331fd80} fill="var(--fill-0, #7E868F)" fillRule="evenodd" id="Vector" />
                  </svg>
                </div>
              </div>
            </div>
...
function Text() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">Overview</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">WAN</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">Interfaces</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">Applications</p>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">Security</p>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#23282e] text-[16px] text-ellipsis whitespace-nowrap">Logs</p>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">Commands</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">Troubleshooting</p>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[22px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[16px] text-ellipsis whitespace-nowrap">Hosted edge services</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Title">
      ...
      <div className="content-stretch flex gap-[32px] items-start relative shrink-0" data-name="Tabs primary">
        ...
        <div className="content-stretch flex flex-col items-center relative shrink-0" data-name=".Tab primary">
          ...
          <div className="bg-[#45991f] h-[3px] rounded-[2px] shrink-0 w-full" data-name="shape" />
        </div>
        <div className="content-stretch flex flex-col items-center relative shrink-0" data-name=".Tab primary">
          <div className="content-stretch flex gap-[6px] items-center px-px py-[8px] relative shrink-0" data-name=".Tab">
            <Text6 />
...
function Description() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Description">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#596069] text-[16px] text-center w-full">No image available</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Location">
      <div className="content-stretch flex flex-col gap-[16px] items-start px-[24px] py-[16px] relative size-full">
        <div className="bg-[#f7f7f7] content-stretch flex flex-col h-[216px] items-center justify-center px-[16px] py-[12px] relative rounded-[6px] shrink-0 w-[335px]" data-name="Empty state">
          <Description />
        </div>
      </div>
    </div>
...
function GenericLeftColSectionsHeaderMapHeader() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Generic left col sections / Header / Map header">
      <Location />
    </div>
  );
}
...
function Text9() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative z-[3]" data-name="Text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full not-italic relative shrink-0 text-[#23282e] text-[14px] w-[min-content]">Information</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute content-stretch flex items-center left-0 top-0 z-[1]" data-name="Controls">
      <div className="content-stretch flex items-start relative shrink-0" data-name=".Add-on">
        <div className="bg-white content-stretch flex items-center justify-center p-[5px] relative rounded-[4px] shrink-0" data-name="Control">
          <div aria-hidden="true" className="absolute border-2 border-[#889099] border-solid inset-0 pointer-events-none rounded-[4px]" />
          <Box />
        </div>
      </div>
    </div>
      ...
      <div className="relative shrink-0 size-[16px]" data-name="CaretUp">
        <div className="absolute inset-[26.56%_14.06%_32.81%_14.06%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.5 6.5">
            <path clipRule="evenodd" d={svgPaths.p2d532000} fill="var(--fill-0, #7E868F)" fillRule="evenodd" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Hostname</p>
      </div>
    </div>
  );
}
...
function Key1() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Version</p>
      </div>
    </div>
  );
}
...
function Key2() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Site ID</p>
      </div>
    </div>
  );
}
...
function Key3() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">System IP</p>
      </div>
    </div>
  );
}
...
function Key4() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Up since</p>
      </div>
    </div>
  );
}
...
function Key5() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Timezone</p>
      </div>
    </div>
  );
}
...
function Key6() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <div className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[0] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Info">
        <div className="absolute inset-[7.81%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.8125 11.8125">
            <g id="Vector">
              <path clipRule="evenodd" d={svgPaths.p3bfb4700} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p3e3edd80} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
              <path d={svgPaths.p3bd00400} fill="var(--fill-0, #7E868F)" />
            </g>
          </svg>
        </div>
      </div>
...
function Key7() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Health</p>
      </div>
      <Icon />
    </div>
  );
...
function Key8() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Chassis number/ID</p>
      </div>
    </div>
  );
}
...
function Key9() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Chassis model</p>
      </div>
    </div>
  );
}
...
function Key10() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Serial number</p>
      </div>
    </div>
  );
}
...
function Key11() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Connected vManage</p>
      </div>
    </div>
  );
}
...
function Key12() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Tags</p>
      </div>
    </div>
  );
}
...
function Value() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">CG113-SDRA</p>
      </div>
    </div>
  );
}
...
function Value1() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Roboto_Mono:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">17.13.01.0.1247</p>
      </div>
    </div>
  );
}
...
function Value2() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Not reported</p>
      </div>
    </div>
  );
}
...
function Value3() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Roboto_Mono:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">1.1.1.113</p>
      </div>
    </div>
  );
}
...
function Value4() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-pre">{`Nov 30, 2024  04:02:00 GMT`}</p>
      </div>
    </div>
  );
}
...
function Value5() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">CST +0800</p>
      </div>
    </div>
  );
}
...
function Value6() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#23282e] text-[0px] whitespace-nowrap">
...
function Value7() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Requires setup</p>
      </div>
    </div>
  );
}
...
function Value12() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">None set</p>
      </div>
    </div>
  );
}
...
function Collapse() {
  return (
    <div className="content-stretch flex flex-col items-start mb-[-2px] py-[2px] relative shrink-0 w-[383px]" data-name="Collapse">
      <div aria-hidden="true" className="absolute border-[#889099] border-b-2 border-solid border-t-2 inset-0 pointer-events-none" />
...
function Text10() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative z-[3]" data-name="Text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full not-italic relative shrink-0 text-[#23282e] text-[14px] w-[min-content]">Status</p>
    </div>
  );
}
...
function Key13() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Reboot (last 90 days)</p>
      </div>
    </div>
  );
}
...
function Key14() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Crash</p>
      </div>
    </div>
  );
}
...
function Key15() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">CPU load</p>
      </div>
    </div>
  );
}
...
function Key16() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Memory utilization</p>
      </div>
    </div>
  );
}
...
function Key17() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Module</p>
      </div>
    </div>
  );
}
...
function Value15() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">30% average</p>
      </div>
    </div>
  );
}
...
function Value16() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">73% average</p>
      </div>
    </div>
  );
}
...
function Value17() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[18px] not-italic relative shrink-0 text-[#1d69cc] text-[12px] whitespace-nowrap">Controller</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative z-[3]" data-name="Text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] min-w-full not-italic relative shrink-0 text-[#23282e] text-[14px] w-[min-content]">Control</p>
    </div>
  );
}
...
function Key18() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Control connections</p>
      </div>
    </div>
  );
}
...
function Key19() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Reachability</p>
      </div>
    </div>
  );
}
...
function Key20() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Control</p>
      </div>
    </div>
  );
}
...
function Key21() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Controller control connection</p>
      </div>
      <Icon1 />
    </div>
  );
...
function Key22() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">BFD</p>
      </div>
    </div>
  );
}
...
function Key23() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Key">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">TLOC</p>
      </div>
    </div>
  );
}
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="Status icon">
        <div className="absolute inset-[9.38%]" data-name="bg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 13">
            <circle cx="6.5" cy="6.5" fill="var(--fill-0, #139BEB)" id="bg" r="6.5" />
          </svg>
        </div>
...
function Value19() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">1/1</p>
      </div>
    </div>
  );
}
...
function Value21() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">0/0</p>
      </div>
    </div>
  );
}
...
function Value22() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Text">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">0/1</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Values">
      ...
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Generic left col value">
        <div className="flex flex-col font-['Inter:SemiBold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">
...
function LeftColumn() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_3px_4px_rgba(0,0,0,0.08)] flex flex-col items-start pb-[24px] pt-[12px] relative rounded-[12px] shrink-0" data-name="Left column">
...
function Text12() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[14px] text-ellipsis whitespace-nowrap">Alarms</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[14px] text-ellipsis whitespace-nowrap">Events</p>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#596069] text-[14px] text-ellipsis whitespace-nowrap">AC logs</p>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#1d69cc] text-[14px] text-ellipsis whitespace-nowrap">OMP statistics</p>
    </div>
  );
}
      ...
      <div className="flex-[1_0_0] h-full min-w-px overflow-clip relative" data-name="Clock">
        <div className="absolute inset-[7.81%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5 13.5">
            <g id="Vector">
              <path clipRule="evenodd" d={svgPaths.p2f37fe00} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p129a3500} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
            </g>
          </svg>
        </div>
      </div>
...
function Type() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0" data-name="Type">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#23282e] text-[14px] text-ellipsis whitespace-nowrap">12 hours</p>
    </div>
  );
}
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="DropdownCaretDown">
        <div className="absolute inset-[36.72%_22.66%_30.47%_22.66%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.75 5.25">
            <path clipRule="evenodd" d={svgPaths.p2a9a0100} fill="var(--fill-0, #7E868F)" fillRule="evenodd" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Field() {
  return (
    <div className="content-stretch flex flex-col h-[34px] items-start relative rounded-[6px] shrink-0 w-[280px] z-[2]" data-name="field">
...
function Type1() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0" data-name="Type">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#889099] text-[14px] text-ellipsis whitespace-nowrap">Select tenant</p>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="text">
      <p className="font-['Sharp_Sans:Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#373c42] text-[18px] whitespace-nowrap">OMP process usage</p>
    </div>
  );
}
...
function Controls3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Controls">
      <div className="bg-white content-stretch flex gap-[4px] items-center justify-center px-[12px] py-[7px] relative rounded-[6px] shrink-0" data-name="Button">
        <div aria-hidden="true" className="absolute border-2 border-[#1d69cc] border-solid inset-0 pointer-events-none rounded-[6px]" />
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#1d69cc] text-[14px] whitespace-nowrap">Export</p>
      </div>
    </div>
  );
}
      ...
      <div className="absolute inset-[21.18%_0_78.82%_0] mask-position-[0px_-35.154px,_0px_-3.192px]" style={{ maskImage: `url('${imgWarningBorder}'), url('${imgWarningBorder1}')` }} data-name="Warning border">
        <div className="absolute inset-[-3px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1181 3">
            <line id="Warning border" stroke="var(--stroke-0, #CC8604)" strokeDasharray="3 3" strokeWidth="3" x2="1181" y1="1.5" y2="1.5" />
          </svg>
        </div>
      </div>
    </div>
      ...
      <div className="absolute inset-[58.74%_-0.3%_-2.41%_-0.38%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[4.5px_-97.503px] mask-size-[1181px_166px]" style={{ maskImage: `url('${imgWarningBorder}')` }} data-name="Line">
        <div className="absolute inset-[-1.39%_0_-1.38%_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1191 74.5065">
            <path d={svgPaths.pe392300} id="Line" stroke="var(--stroke-0, #C2306F)" strokeDasharray="2 2" strokeWidth="2" />
          </svg>
        </div>
      </div>
    </div>
          ...
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[3.999px_-72.001px] mask-size-[1181px_166px] relative size-full" style={{ maskImage: `url('${imgWarningBorder}')` }} data-name="Line">
            <div className="absolute inset-[-1.03%_0_-1.02%_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1192.52 100.036">
                <path d={svgPaths.p1c9af00} id="Line" stroke="var(--stroke-0, #A974F7)" strokeDasharray="2 2" strokeWidth="2" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <div className="absolute inset-[44.63%_0_0_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_-74.082px] mask-size-[1181px_166px]" style={{ maskImage: `url('${imgWarningBorder}')` }} data-name="Line">
        <div className="absolute inset-[-2.25%_-0.17%_-2.18%_-0.17%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1185 95.9887">
            <path d={svgPaths.pe933f80} id="Line" stroke="var(--stroke-0, #04A4B0)" strokeWidth="2" />
          </svg>
        </div>
      </div>
          ...
          <div className="-scale-y-100 flex-none">
            <div className="relative size-[9px]">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
                <path d="M4.5 0L9 9H0L4.5 0Z" fill="var(--fill-0, #04A4B0)" id="Polygon 2" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <div className="absolute inset-[16.15%_-0.08%_-0.52%_-0.04%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0.5px_-26.803px] mask-size-[1181px_166px]" style={{ maskImage: `url('${imgWarningBorder}')` }} data-name="Line">
        <div className="absolute inset-[-1.66%_-0.17%_-1.43%_-0.17%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1186.5 144.386">
            <path d={svgPaths.p7144500} id="Line" stroke="var(--stroke-0, #505ED9)" strokeWidth="2" />
          </svg>
        </div>
      </div>
        ...
        <div className="relative shrink-0 size-[9px]">
          <div className="absolute inset-[-11.11%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
              <circle cx="5.5" cy="5.5" fill="var(--fill-0, #505ED9)" id="Ellipse 1" r="5" stroke="var(--stroke-0, white)" />
            </svg>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">00:00</p>
      </div>
    </div>
  );
}
...
function XAxis2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">01:00</p>
      </div>
    </div>
  );
}
...
function XAxis3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">02:00</p>
      </div>
    </div>
  );
}
...
function XAxis4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">03:00</p>
      </div>
    </div>
  );
}
...
function XAxis5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">04:00</p>
      </div>
    </div>
  );
}
...
function XAxis6() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">05:00</p>
      </div>
    </div>
  );
}
...
function XAxis7() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">06:00</p>
      </div>
    </div>
  );
}
...
function XAxis8() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">07:00</p>
      </div>
    </div>
  );
}
...
function XAxis9() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">08:00</p>
      </div>
    </div>
  );
}
...
function XAxis10() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">09:00</p>
      </div>
    </div>
  );
}
...
function XAxis11() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">10:00</p>
      </div>
    </div>
  );
}
...
function XAxis12() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-full items-start justify-center relative shrink-0 w-0" data-name="x-axis">
      <div className="-translate-x-1/2 absolute bottom-[-31px] content-stretch flex h-[18px] items-center justify-center left-[calc(50%+0.5px)] w-px" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#373c42] text-[12px] text-right whitespace-nowrap">11:00</p>
      </div>
    </div>
  );
}
    ...
    <div className="h-0 relative w-full" data-name="Chart line">
      <div className="absolute inset-[-1px_-0.68%_0_-0.76%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1198 1">
          <g id="Chart line">
            <line id="Line" stroke="var(--stroke-0, #7E868F)" strokeDasharray="2 2" x2="1198" y1="0.5" y2="0.5" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[8px] h-px items-start relative shrink-0 w-full" data-name="y-axis">
      ...
      <div className="absolute content-stretch flex h-[18px] items-center justify-end left-[-33px] top-[-8.5px] w-[21px]" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">100%</p>
      </div>
    </div>
  );
}
...
function YAxis2() {
  return (
    <div className="content-stretch flex gap-[8px] h-px items-start relative shrink-0 w-full" data-name="y-axis">
      ...
      <div className="absolute content-stretch flex h-[18px] items-center justify-end left-[-33px] top-[-8.5px] w-[21px]" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">80%</p>
      </div>
    </div>
  );
}
...
function YAxis3() {
  return (
    <div className="content-stretch flex gap-[8px] h-px items-start relative shrink-0 w-full" data-name="y-axis">
      ...
      <div className="absolute content-stretch flex h-[18px] items-center justify-end left-[-33px] top-[-8.5px] w-[21px]" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">60%</p>
      </div>
    </div>
  );
}
...
function YAxis4() {
  return (
    <div className="content-stretch flex gap-[8px] h-px items-start relative shrink-0 w-full" data-name="y-axis">
      ...
      <div className="absolute content-stretch flex h-[18px] items-center justify-end left-[-33px] top-[-8.5px] w-[21px]" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">40%</p>
      </div>
    </div>
  );
}
...
function YAxis5() {
  return (
    <div className="content-stretch flex gap-[8px] h-px items-start relative shrink-0 w-full" data-name="y-axis">
      ...
      <div className="absolute content-stretch flex h-[18px] items-center justify-end left-[-33px] top-[-8.5px] w-[21px]" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">20%</p>
      </div>
    </div>
  );
}
...
function YAxis6() {
  return (
    <div className="content-stretch flex gap-[8px] h-px items-start relative shrink-0 w-full" data-name="y-axis">
      ...
      <div className="absolute content-stretch flex h-[18px] items-center justify-end left-[-33px] top-[-8.5px] w-[21px]" data-name=".Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-right whitespace-nowrap">0%</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex h-full items-center justify-center relative shrink-0 w-[18px]" style={{ containerType: "size", "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none w-[100cqh]">
          <div className="content-stretch flex gap-[4px] h-[18px] items-center justify-center relative w-full" data-name=".Axis description">
            <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">CPU / memory (%)</p>
          </div>
        </div>
      </div>
      <Data1 />
  ...
  return (
    <div className="relative shrink-0 size-[23px]" data-name="Legend shape">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 23">
        <g id="Legend shape">
          <path clipRule="evenodd" d="M4 13H1V10H4V13Z" fill="var(--fill-0, #A974F7)" fillRule="evenodd" id="line" />
          <path clipRule="evenodd" d="M10 13H7V10H10V13Z" fill="var(--fill-0, #A974F7)" fillRule="evenodd" id="line_2" />
          <path clipRule="evenodd" d="M16 13H13V10H16V13Z" fill="var(--fill-0, #A974F7)" fillRule="evenodd" id="line_3" />
          <path clipRule="evenodd" d="M22 13H19V10H22V13Z" fill="var(--fill-0, #A974F7)" fillRule="evenodd" id="line_4" />
        </g>
      </svg>
    </div>
  );
...
function Value23() {
  return (
    <div className="bg-white content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 18">
      <LegendIcon />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">OMP CPU average</p>
    </div>
  );
}
...
function LegendShape1() {
  return (
    <div className="relative shrink-0 size-[23px]" data-name="Legend shape">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 23">
        <g id="Legend shape">
          <path clipRule="evenodd" d="M4 13H1V10H4V13Z" fill="var(--fill-0, #C2306F)" fillRule="evenodd" id="line" />
          <path clipRule="evenodd" d="M10 13H7V10H10V13Z" fill="var(--fill-0, #C2306F)" fillRule="evenodd" id="line_2" />
          <path clipRule="evenodd" d="M16 13H13V10H16V13Z" fill="var(--fill-0, #C2306F)" fillRule="evenodd" id="line_3" />
          <path clipRule="evenodd" d="M22 13H19V10H22V13Z" fill="var(--fill-0, #C2306F)" fillRule="evenodd" id="line_4" />
        </g>
      </svg>
    </div>
  );
...
function Value24() {
  return (
    <div className="bg-white content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 17">
      <LegendIcon1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">OMP memory average</p>
    </div>
  );
}
...
function LegendShape2() {
  return (
    <div className="relative shrink-0 size-[23px]" data-name="Legend shape">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 23">
        <g id="Legend shape">
          <path clipRule="evenodd" d="M6.5 13.5H2.5V9.5H6.5V13.5Z" fill="var(--fill-0, #CC8604)" fillRule="evenodd" id="line" />
          <path clipRule="evenodd" d={svgPaths.p1e4f2770} fill="var(--fill-0, #CC8604)" fillRule="evenodd" id="line_2" />
          <path clipRule="evenodd" d={svgPaths.pb362f80} fill="var(--fill-0, #CC8604)" fillRule="evenodd" id="line_3" />
        </g>
      </svg>
    </div>
  );
...
function Value25() {
  return (
    <div className="bg-white content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 11">
      <LegendIcon2 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">{`CPU & memory warning threshold`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-start flex flex-[1_0_0] flex-wrap gap-[4px_24px] items-start min-w-px relative" data-name="1st Line">
      <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 2">
          ...
          <div className="content-stretch flex gap-[6px] items-start p-[7px] relative shrink-0" data-name="Legend shape">
            <div className="-translate-y-1/2 absolute h-[3px] left-0 right-0 top-1/2" data-name="line">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 3">
                <path clipRule="evenodd" d="M23 3H0V0H23V3Z" fill="var(--fill-0, #505ED9)" fillRule="evenodd" id="line" />
              </svg>
            </div>
        ...
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">OMP CPU usage</p>
      </div>
      <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 3">
        <div className="content-stretch flex items-start p-[2px] relative shrink-0 size-[28px]" data-name="Legend icon">
          <div className="content-stretch flex gap-[6px] items-start p-[7px] relative shrink-0" data-name="Legend shape">
            <div className="-translate-y-1/2 absolute h-[3px] left-0 right-0 top-1/2" data-name="line">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 3">
                <path clipRule="evenodd" d="M23 3H0V0H23V3Z" fill="var(--fill-0, #04A4B0)" fillRule="evenodd" id="line" />
              </svg>
            </div>
            <div className="flex items-center justify-center relative shrink-0">
              <div className="-scale-y-100 flex-none">
                <div className="relative size-[9px]" data-name="icon">
                  <div className="absolute inset-[-24.85%_-17.98%_-11.11%_-17.98%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.2361 12.2361">
                      <path d={svgPaths.p121b6d00} fill="var(--fill-0, #04A4B0)" id="icon" stroke="var(--stroke-0, white)" />
                    </svg>
                  </div>
                </div>
              </div>
        ...
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">OMP memory usage</p>
      </div>
      <Value23 />
      <Value24 />
      <Value25 />
...
function Text19() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="text">
      <p className="font-['Sharp_Sans:Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#373c42] text-[18px] whitespace-nowrap">Event</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-start min-h-px relative w-full" data-name="Data">
      <div className="flex h-full items-center justify-center relative shrink-0 w-[18px]" style={{ containerType: "size", "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none w-[100cqh]">
          <div className="content-stretch flex gap-[4px] h-[18px] items-center justify-center relative w-full" data-name=".Axis description">
            <p className="font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Number of events</p>
          </div>
        </div>
      </div>
      <Data3 />
      ...
      <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 1">
        <div className="content-stretch flex items-start relative shrink-0" data-name="Main Legend">
          <div className="content-stretch flex gap-[6px] isolate items-start p-[6px] relative shrink-0" data-name="Legend - Color/Pattern">
            <div className="bg-[#505ed9] overflow-clip rounded-[2px] shrink-0 size-[16px] z-[1]" data-name="Visual pattern" />
          </div>
        </div>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Control connection state change</p>
      </div>
      <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 2">
        <div className="content-stretch flex items-start relative shrink-0" data-name="Main Legend">
          <div className="content-stretch flex gap-[6px] isolate items-start p-[6px] relative shrink-0" data-name="Legend - Color/Pattern">
            <div className="bg-[#04a4b0] overflow-clip rounded-[2px] shrink-0 size-[16px] z-[1]" data-name="Visual pattern" />
          </div>
        </div>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">{`OMP peer state change `}</p>
      </div>
      <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Value 3">
        <div className="content-stretch flex items-start relative shrink-0" data-name="Main Legend">
          <div className="content-stretch flex gap-[6px] isolate items-start p-[6px] relative shrink-0" data-name="Legend - Color/Pattern">
            <div className="bg-[#a974f7] overflow-clip rounded-[2px] shrink-0 size-[16px] z-[1]" data-name="Visual pattern" />
          </div>
        </div>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">Policy change</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[124px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      ...
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">00:00</p>
      </div>
    </div>
  );
}
...
function BarSingle1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars1 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">01:00</p>
      </div>
    </div>
  );
}
...
function BarSingle2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[124px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars2 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">02:00</p>
      </div>
    </div>
  );
}
...
function BarSingle3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[99px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars3 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">03:00</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[106px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      ...
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-full" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">04:00</p>
      </div>
    </div>
  );
}
...
function BarSingle5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[168px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars5 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">05:00</p>
      </div>
    </div>
  );
}
...
function BarSingle6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[121px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars6 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">06:00</p>
      </div>
    </div>
  );
}
...
function BarSingle7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[65px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars7 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">07:00</p>
      </div>
    </div>
  );
}
...
function BarSingle8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[109px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars8 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">08:00</p>
      </div>
    </div>
  );
}
...
function BarSingle9() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[117px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars9 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">09:00</p>
      </div>
    </div>
  );
}
...
function BarSingle10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[137px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars10 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">10:00</p>
      </div>
    </div>
  );
}
...
function BarSingle11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center justify-end min-w-px relative" data-name="Bar - Single">
      <Bars11 />
      <div className="content-stretch flex h-[18px] items-start justify-center relative shrink-0 w-[24px]" data-name="Label">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] text-center whitespace-nowrap">11:00</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="MagnifyingGlass">
        <div className="absolute inset-[7.81%_7.82%_7.81%_7.81%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.4996 13.5001">
            <g id="Vector">
              <path clipRule="evenodd" d={svgPaths.p1fecfe00} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p2f0a18f0} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
            </g>
          </svg>
        </div>
      </div>
...
function Indicator() {
  return (
    <div className="h-[18px] relative shrink-0 w-px" data-name="Indicator">
      <div className="absolute bg-[#23282e] h-[20px] left-0 opacity-0 top-[-2px] w-px" data-name="|" />
    </div>
  );
}
...
function Type2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px overflow-clip relative" data-name="Type">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#889099] text-[14px] whitespace-nowrap">Search</p>
      <Indicator />
    </div>
  );
}
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="XCircle">
        <div className="absolute inset-[7.81%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5 13.5">
            <g id="Vector">
              <path clipRule="evenodd" d={svgPaths.p2f37fe00} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.pd422380} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
            </g>
          </svg>
        </div>
      </div>
...
function Type3() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0" data-name="Type">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#889099] text-[14px] text-ellipsis whitespace-nowrap">System IP</p>
    </div>
  );
}
...
function Type4() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0" data-name="Type">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#889099] text-[14px] text-ellipsis whitespace-nowrap">Site name</p>
    </div>
  );
}
...
function Type5() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0" data-name="Type">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#889099] text-[14px] text-ellipsis whitespace-nowrap">Event type</p>
    </div>
  );
}
...
function Results() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="results">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#596069] text-[14px] whitespace-nowrap">316 results</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[20px]" data-name="SortDown">
        <div className="absolute inset-[60.73%_35.42%_22.61%_35.42%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.83336 3.33337">
            <path d={svgPaths.p761a300} fill="var(--fill-0, #7E868F)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[23.23%_35.42%_60.1%_35.42%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.83336 3.33337">
            <path d={svgPaths.pb91c6c0} fill="var(--fill-0, #D0D4D9)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function HeaderTitle() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Event time</p>
      <Icon10 />
    </div>
  );
}
...
function HeaderTitle1() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">System IP</p>
    </div>
  );
}
...
function HeaderTitle2() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Hostname</p>
    </div>
  );
}
...
function HeaderTitle3() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Site name</p>
    </div>
  );
}
...
function HeaderTitle4() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Event name</p>
    </div>
  );
}
...
function HeaderTitle5() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Details</p>
    </div>
  );
}
...
function HeaderTitle6() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Routes sent</p>
    </div>
  );
}
...
function HeaderTitle7() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Routes received</p>
    </div>
  );
}
...
function HeaderTitle8() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Header title">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#23282e] text-[14px] whitespace-nowrap">Peers</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Header">
      <div className="content-stretch flex items-start pb-[6px] pt-[4px] px-[8px] relative shrink-0 w-[181px]" data-name="Cell">
        <div aria-hidden="true" className="absolute border-[#656c75] border-b-2 border-solid inset-0 pointer-events-none" />
              ...
              <div className="flex-[1_0_0] h-full min-w-px relative" data-name="GearSix">
                <div className="absolute inset-[6.89%_4.6%_6.93%_4.68%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.5141 13.7902">
                    <g id="Vector">
                      <path clipRule="evenodd" d={svgPaths.p15990d00} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
                      <path clipRule="evenodd" d={svgPaths.p1c5da700} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
                    </g>
                  </svg>
                </div>
              </div>
  ...
  return (
    <div className="bg-white content-stretch flex items-start relative shrink-0 w-full" data-name="Row">
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[181px]" data-name="Cell">
        <div aria-hidden="true" className="absolute border-[#e1e4e8] border-b border-solid inset-0 pointer-events-none" />
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <div className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[0] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">
      ...
      <div className="relative self-stretch shrink-0 w-[99px]" data-name="Cell">
        ...
        <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative size-full">
          <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Monospace">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
              <div className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] leading-[0] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">
      ...
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[189px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">Control connection state change</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[266px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">peer-type=vedge;peer=1.1.2.3;peer-new-state=control-connection-up</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[98px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start justify-end py-[4px] relative size-full">
            <div className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[0] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px] text-right">
              ...
              <div className="flex-[1_0_0] h-full min-w-px relative" data-name="DotsThree">
                <div className="absolute inset-[43.75%_18.75%]" data-name="Vector">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 2">
                    <g id="Vector">
                      <path d={svgPaths.p25258f70} fill="var(--fill-0, #7E868F)" />
                      <path d={svgPaths.p39bde000} fill="var(--fill-0, #7E868F)" />
                      <path d={svgPaths.p23e70e80} fill="var(--fill-0, #7E868F)" />
                    </g>
                  </svg>
                </div>
              </div>
  ...
  return (
    <div className="bg-white content-stretch flex items-start relative shrink-0 w-full" data-name="Row">
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[181px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">Apr 05, 2025 04:10 AM</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[99px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Monospace">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">1.1.1.53</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[104px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">vSmart2</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[121px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">San Francisco</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[189px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">Policy change</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[266px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">policy-type:control-policy</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[98px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start justify-end py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px] text-right">53</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[127px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start justify-end py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px] text-right">41</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[56px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start justify-end py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px] text-right">3</p>
          </div>
        </div>
      </div>
    ...
    <div className="bg-white content-stretch flex items-start relative shrink-0 w-full" data-name="Row">
      ...
      <div className="relative self-stretch shrink-0 w-[99px]" data-name="Cell">
        ...
        <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative size-full">
          <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Monospace">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
              <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">1.1.1.50</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[266px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">peer-type=vedge;peer=1.1.2.4;new-omp-state=up-in-gr</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[98px]" data-name="Cell">
  ...
  return (
    <div className="bg-white content-stretch flex items-start relative shrink-0 w-full" data-name="Row">
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[181px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">Apr 05, 2025 05:35 AM</p>
          </div>
        </div>
      </div>
      <div className="relative self-stretch shrink-0 w-[99px]" data-name="Cell">
        ...
        <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative size-full">
          <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Monospace">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
              <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">1.1.1.45</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-white content-stretch flex items-start relative shrink-0 w-full" data-name="Row">
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[181px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">Apr 05, 2025 07:20 AM</p>
          </div>
        </div>
      </div>
      <div className="relative self-stretch shrink-0 w-[99px]" data-name="Cell">
        ...
        <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative size-full">
          <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Monospace">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start py-[4px] relative size-full">
              <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px]">1.1.1.56</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[98px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start justify-end py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px] text-right">62</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[127px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start justify-end py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px] text-right">36</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start justify-end pb-[5px] pt-[4px] px-[8px] relative shrink-0 w-[56px]" data-name="Cell">
        ...
        <div className="flex-[1_0_0] h-[28px] min-w-px relative" data-name="Type=Body">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-start justify-end py-[4px] relative size-full">
            <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative self-stretch text-[#23282e] text-[14px] text-right">1</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex items-start pb-[5px] pt-[4px] px-[8px] relative shrink-0" data-name="Cell">
...
function Type6() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0 w-[186px]" data-name="Type">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#23282e] text-[14px] text-ellipsis whitespace-nowrap">10</p>
    </div>
  );
}
...
function RowsPerPage() {
  return (
    <div className="content-stretch flex gap-[8px] h-[34px] items-center justify-end relative shrink-0" data-name="Rows per page">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#23282e] text-[14px] text-center whitespace-nowrap">
        ...
        <div className="relative shrink-0 size-[20px]" data-name="CaretLeft">
          <div className="absolute inset-[14.06%_32.81%_14.06%_26.56%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.125 14.375">
              <path clipRule="evenodd" d={svgPaths.p34e27e80} fill="var(--fill-0, #D0D4D9)" fillRule="evenodd" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
      <div className="bg-white content-stretch flex items-center justify-center relative rounded-[6px] shrink-0 size-[28px]" data-name=".PageNumber">
        <div aria-hidden="true" className="absolute border-2 border-[#2774d9] border-solid inset-0 pointer-events-none rounded-[6px]" />
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative text-[#23282e] text-[14px] text-center">1</p>
      </div>
      <div className="bg-white content-stretch flex items-center justify-center relative rounded-[6px] shrink-0 size-[28px]" data-name=".PageNumber">
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative text-[#23282e] text-[14px] text-center">2</p>
      </div>
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 size-[34px] text-[#23282e] text-[14px] text-center">
        <p className="leading-[20px]">...</p>
      </div>
      <div className="bg-white content-stretch flex items-center justify-center relative rounded-[6px] shrink-0 size-[28px]" data-name=".PageNumber">
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative text-[#23282e] text-[14px] text-center">10</p>
      </div>
      <div className="content-stretch flex items-center justify-center p-[7px] relative rounded-[6px] shrink-0" data-name="Button">
        <div className="relative shrink-0 size-[20px]" data-name="CaretRight">
          <div className="absolute inset-[14.06%_26.56%_14.06%_32.81%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.125 14.375">
              <path clipRule="evenodd" d={svgPaths.pf671600} fill="var(--fill-0, #7E868F)" fillRule="evenodd" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function Container() {
  return (
    <div className="bg-white drop-shadow-[0px_3px_4px_rgba(0,0,0,0.08)] relative rounded-[12px] shrink-0 w-full" data-name="container">
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[24px] relative size-full">
        <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Tabs secondary">
          ...
          <div className="content-stretch flex flex-col items-center relative shrink-0" data-name=".Tab secondary">
            ...
            <div className="bg-[#2774d9] h-[3px] rounded-[2px] shrink-0 w-full" data-name="shape" />
          </div>
        </div>
        ...
        <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Filter bar">
          <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[240px]" data-name="Search input">
            <div className="bg-white h-[34px] relative rounded-[6px] shrink-0 w-full" data-name=".Field">
            ...
            <div className="flex flex-row items-center justify-end size-full">
              <div className="content-stretch flex gap-[16px] items-center justify-end pl-[36px] relative size-full">
                <div className="content-stretch flex items-center pr-[8px] relative shrink-0" data-name="Text">
                  <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#596069] text-[12px] whitespace-nowrap">Optional context message</p>
                </div>
        ...
        <div className="content-stretch flex gap-[8px] items-center justify-end relative shrink-0 w-full" data-name="Pagination">
          <RowsPerPage />
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#596069] text-[14px] text-center whitespace-nowrap">
...
function Copyright() {
  return (
    <div className="content-stretch flex items-center justify-center pr-[36px] relative shrink-0" data-name="Copyright">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#23282e] text-[12px] whitespace-nowrap">© 2026 Cisco Systems, Inc.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-start flex flex-[1_0_0] flex-wrap gap-[12px_16px] items-start justify-end min-w-px relative" data-name="Links">
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Text link">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[18px] not-italic relative shrink-0 text-[#1d69cc] text-[12px] whitespace-nowrap">Privacy policy</p>
      </div>
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Text link">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[18px] not-italic relative shrink-0 text-[#1d69cc] text-[12px] whitespace-nowrap">Terms of service</p>
      </div>
    </div>
  );
}
          ...
          <div className="h-0 relative shrink-0 w-full" data-name="line">
            <div className="absolute inset-[-0.5px_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1325 1">
                <path d="M0 0.5H1325" id="line" stroke="var(--stroke-0, #E1E4E8)" />
              </svg>
            </div>
          </div>
        </div>
...
function Content() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Content">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px not-italic overflow-hidden relative text-[#23282e] text-[12px] text-center text-ellipsis">
    ...
    <div className="flex-[1_0_0] min-w-px relative" data-name="Container">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-center px-[8px] py-[12px] relative size-full">
          <div className="relative shrink-0 size-[32px]" data-name="Icon / Organization Switcher">
            <div className="absolute inset-[58.33%_8.33%_8.33%_8.33%]" data-name="Weak">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.6667 10.6667">
                <path clipRule="evenodd" d={svgPaths.p1d46f700} fill="var(--fill-0, #C1C6CC)" fillRule="evenodd" id="Weak" />
              </svg>
            </div>
            <div className="absolute inset-[14.23%_18.39%_47.56%_54.42%]" data-name="Medium">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.70017 12.2288">
                <path d={svgPaths.p2b30df40} fill="var(--fill-0, #A7ADB5)" id="Medium" />
              </svg>
            </div>
            <div className="absolute inset-[14.23%_43.39%_47.56%_18.39%]" data-name="Default">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.2288 12.2288">
                <path d={svgPaths.p2b048a50} fill="var(--fill-0, #7E868F)" id="Default" />
              </svg>
            </div>
          </div>
          <Content />
...
function Indicator1() {
  return (
    <div className="absolute bottom-0 content-stretch flex items-center left-0 overflow-clip rounded-bl-[8px] rounded-tl-[8px] top-0 w-[8px] z-[3]" data-name="Indicator">
      <div className="bg-[#45991f] h-full shrink-0 w-[4px]" data-name="Selected Indicator" />
    </div>
  );
}
...
function Content1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#23282e] text-[12px] text-center text-ellipsis">Monitor</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon / Monitor">
        <div className="absolute inset-[10.42%_16.67%_27.08%_8.33%]" data-name="Weak">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 15">
            <g id="Weak">
              <path d={svgPaths.p2a28ad00} fill="var(--fill-0, #6BBF41)" />
              <path d={svgPaths.p30e26800} fill="var(--fill-0, #6BBF41)" />
            </g>
          </svg>
        </div>
        <div className="absolute bottom-[10.42%] left-1/2 right-[8.33%] top-[47.92%]" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10.0002">
            <path clipRule="evenodd" d={svgPaths.p26e8a00} fill="var(--fill-0, #45991F)" fillRule="evenodd" id="Default" />
          </svg>
        </div>
      </div>
      <Content1 />
...
function Content2() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#596069] text-[12px] text-center text-ellipsis">Configuration</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon / Configuration">
        <div className="absolute inset-[56.87%_58.77%_6.91%_8.75%]" data-name="Medium">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.79423 8.6906">
            <path clipRule="evenodd" d={svgPaths.p2178b300} fill="var(--fill-0, #A7ADB5)" fillRule="evenodd" id="Medium" />
          </svg>
        </div>
        <div className="absolute bottom-[22.92%] left-1/4 right-[6.25%] top-[8.33%]" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.5 16.5002">
            <path d={svgPaths.p27baadf0} fill="var(--fill-0, #7E868F)" id="Default" />
          </svg>
        </div>
      </div>
      <Content2 />
...
function Content3() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#596069] text-[12px] text-center text-ellipsis">Tools</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon /  Tools">
        <div className="absolute inset-[10.21%_9.59%_55.91%_56.53%]" data-name="Medium">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.13088 8.13116">
            <path d={svgPaths.p2e750370} fill="var(--fill-0, #A7ADB5)" id="Medium" />
          </svg>
        </div>
        <div className="absolute inset-[55.56%_55.14%_10.21%_10.63%]" data-name="Weak">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.21458 8.21495">
            <path d={svgPaths.p295d5500} fill="var(--fill-0, #C1C6CC)" id="Weak" />
          </svg>
        </div>
        <div className="absolute inset-[10.21%_13.33%_12.71%_9.59%]" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.5 18.5002">
            <path d={svgPaths.p260afd30} fill="var(--fill-0, #7E868F)" id="Default" />
          </svg>
        </div>
      </div>
      <Content3 />
...
function Content4() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#596069] text-[12px] text-center text-ellipsis">Maintenance</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon / Maintenance">
        <div className="absolute inset-[64.58%_12.5%_6.25%_12.5%]" data-name="Weak">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 7">
            <path clipRule="evenodd" d={svgPaths.p10fd3540} fill="var(--fill-0, #C1C6CC)" fillRule="evenodd" id="Weak" />
          </svg>
        </div>
        <div className="absolute inset-[6.25%_26.87%_43.75%_26.87%]" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.1028 12">
            <path clipRule="evenodd" d={svgPaths.pde9c800} fill="var(--fill-0, #7E868F)" fillRule="evenodd" id="Default" />
          </svg>
        </div>
      </div>
      <Content4 />
...
function Content5() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#596069] text-[12px] text-center text-ellipsis">Administration</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon / Admin">
        <div className="absolute inset-[16.67%_48.55%_20.83%_4.17%]" data-name="Medium">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.3471 15">
            <path d={svgPaths.p2735700} fill="var(--fill-0, #A7ADB5)" id="Medium" />
          </svg>
        </div>
        <div className="absolute inset-[45.83%_1.97%_9.62%_58.33%]" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.52628 10.6906">
            <path clipRule="evenodd" d={svgPaths.p11b4b400} fill="var(--fill-0, #7E868F)" fillRule="evenodd" id="Default" />
          </svg>
        </div>
      </div>
      <Content5 />
...
function Content6() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#596069] text-[12px] text-center text-ellipsis">Workflows</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon / Workflows">
        <div className="absolute inset-[13.54%_7.29%_13.54%_10.42%]" data-name="Weak">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.75 17.5">
            <path clipRule="evenodd" d={svgPaths.p1dbfc100} fill="var(--fill-0, #C1C6CC)" fillRule="evenodd" id="Weak" />
          </svg>
        </div>
        <div className="absolute inset-[36.71%_0]" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 6.37868">
            <g id="Default">
              <path d={svgPaths.pa116a00} fill="var(--fill-0, #7E868F)" />
              <path d={svgPaths.p7e01800} fill="var(--fill-0, #7E868F)" />
              <path d={svgPaths.p9666b00} fill="var(--fill-0, #7E868F)" />
            </g>
          </svg>
        </div>
        <div className="absolute inset-[8.33%_20.83%_8.33%_37.5%]" data-name="Medium">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 20">
            <g id="Medium">
              <path d={svgPaths.p3dfcb940} fill="var(--fill-0, #A7ADB5)" />
              <path d={svgPaths.p2f12100} fill="var(--fill-0, #A7ADB5)" />
            </g>
          </svg>
        </div>
      </div>
...
function Content7() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#596069] text-[12px] text-center text-ellipsis">Analytics</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon / Analytics">
        <div className="absolute bottom-[12.5%] left-[12.5%] right-3/4 top-[54.17%]" data-name="Weak">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 8">
            <path d={svgPaths.p2edaca00} fill="var(--fill-0, #C1C6CC)" id="Weak" />
          </svg>
        </div>
        <div className="absolute inset-[45.83%_33.33%_12.5%_54.17%]" data-name="Medium">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 10">
            <path d={svgPaths.p255fee40} fill="var(--fill-0, #A7ADB5)" id="Medium" />
          </svg>
        </div>
        <div className="absolute bottom-[12.5%] left-[33.33%] right-[12.5%] top-1/4" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 15">
            <g id="Default">
              <path d={svgPaths.p1812200} fill="var(--fill-0, #7E868F)" />
              <path d={svgPaths.pfe13100} fill="var(--fill-0, #7E868F)" />
            </g>
          </svg>
        </div>
      </div>
...
function Content8() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Content">
      <p className="flex-[1_0_0] font-['Inter:SemiBold',sans-serif] font-semibold leading-[18px] min-w-px not-italic overflow-hidden relative text-[#596069] text-[12px] text-center text-ellipsis">Report</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[24px]" data-name="Icon /  Reports">
        <div className="absolute h-[21.5px] left-[3.25px] top-[1.25px] w-[17.5px]" data-name="Default">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5 21.5">
            <g id="Default">
              <path clipRule="evenodd" d={svgPaths.p4581a00} fill="var(--fill-0, #7E868F)" fillRule="evenodd" />
              <path d={svgPaths.p23e50600} fill="var(--fill-0, #7E868F)" />
              <path d={svgPaths.pce57cf0} fill="var(--fill-0, #7E868F)" />
            </g>
          </svg>
        </div>
        <div className="absolute h-[11.75px] left-[6.25px] top-[7.5px] w-[10.5px]" data-name="Medium">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 11.75">
            <g id="Medium">
              <path clipRule="evenodd" d={svgPaths.p38635680} fill="var(--fill-0, #A7ADB5)" fillRule="evenodd" />
              <path clipRule="evenodd" d={svgPaths.p20243ff2} fill="var(--fill-0, #A7ADB5)" fillRule="evenodd" />
              <path d={svgPaths.p26e9ca00} fill="var(--fill-0, #A7ADB5)" />
              <path d={svgPaths.p6c95400} fill="var(--fill-0, #A7ADB5)" />
            </g>
          </svg>
        </div>
      </div>
...
function NavItems() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 z-[1]" data-name="Nav Items">
      <div className="bg-[#f0f1f2] content-stretch flex isolate items-center justify-center min-h-[70px] px-[8px] py-[4px] relative rounded-[8px] shrink-0 w-[104px]" data-name=".Nav item">
        <Indicator1 />
        <Container5 />
        <SubItems />
      </div>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] isolate items-center min-h-px relative" data-name="Nav Group">
      <div className="content-stretch flex items-start min-h-[70px] relative rounded-[8px] shrink-0 w-[104px] z-[2]" data-name=".Switcher">
        <div aria-hidden="true" className="absolute border-2 border-[#e1e4e8] border-solid inset-0 pointer-events-none rounded-[8px]" />
        <Container4 />
      </div>
      <NavItems />
    </div>
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[37.583px]" data-name="cisco">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.5827 20.0001">
        <g id="cisco">
          <path d={svgPaths.p2614f700} fill="var(--fill-0, #F7F7F7)" id="Vector" />
          <path d={svgPaths.p1c785300} fill="var(--fill-0, #F7F7F7)" id="Vector_2" />
          <path d={svgPaths.p2982ab00} fill="var(--fill-0, #F7F7F7)" id="Vector_3" />
          <path d={svgPaths.p12fbd700} fill="var(--fill-0, #F7F7F7)" id="Vector_4" />
          <path d={svgPaths.pf160900} fill="var(--fill-0, #F7F7F7)" id="Vector_5" />
          <path d={svgPaths.p2c229540} fill="var(--fill-0, #F7F7F7)" id="Vector_6" />
          <path d={svgPaths.p2b68e100} fill="var(--fill-0, #F7F7F7)" id="Vector_7" />
          <path d={svgPaths.p18a55af0} fill="var(--fill-0, #F7F7F7)" id="Vector_8" />
          <path d={svgPaths.p358739c0} fill="var(--fill-0, #F7F7F7)" id="Vector_9" />
          <path d={svgPaths.p28381700} fill="var(--fill-0, #F7F7F7)" id="Vector_10" />
          <path d={svgPaths.p25147200} fill="var(--fill-0, #F7F7F7)" id="Vector_11" />
          <path d={svgPaths.p11665980} fill="var(--fill-0, #F7F7F7)" id="Vector_12" />
          <path d={svgPaths.p36126e80} fill="var(--fill-0, #F7F7F7)" id="Vector_13" />
          <path d={svgPaths.p36009b50} fill="var(--fill-0, #F7F7F7)" id="Vector_14" />
        </g>
      </svg>
    </div>
  );
...
function ProductName() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Product Name">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#f7f7f7] text-[19px] whitespace-nowrap">
  ...
  return (
    <div className="absolute inset-[12.5%_8.46%_8.54%_8.33%]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.97 18.9505">
        <g id="Group 164110">
          <path d={svgPaths.p2a10f400} fill="var(--fill-0, #F7F7F7)" id="Vector" />
          <path d={svgPaths.p6e68940} fill="var(--fill-0, #F7F7F7)" id="Vector_2" />
          <path d={svgPaths.p29494780} fill="var(--fill-0, #F7F7F7)" id="Vector_3" />
          <path d={svgPaths.p3ce67c00} fill="var(--fill-0, #F7F7F7)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function HeaderDivider() {
  return (
    <div className="bg-[#f7f7f7] h-[24px] relative shrink-0 w-px" data-name="Header / Divider">
      ...
      <div className="relative shrink-0 size-[24px]" data-name="User">
        <div className="absolute inset-[7.81%_7.42%_10.94%_7.42%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.4379 19.5001">
            <path clipRule="evenodd" d={svgPaths.pa7743d0} fill="var(--fill-0, #F7F7F7)" fillRule="evenodd" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Text25() {
  return (
    <div className="content-stretch flex flex-col h-[36px] items-start justify-center leading-[0] not-italic pb-[4px] relative shrink-0 text-[#f7f7f7] text-[14px] whitespace-nowrap" data-name="Text">
  ...
  return (
    <div className="content-stretch flex items-center justify-end px-[8px] py-[10px] relative shrink-0" data-name="Caret">
      <div className="relative shrink-0 size-[16px]" data-name="DropdownCaretDown">
        <div className="absolute inset-[36.72%_22.66%_30.47%_22.66%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.75 5.25">
            <path clipRule="evenodd" d={svgPaths.p2a9a0100} fill="var(--fill-0, #F7F7F7)" fillRule="evenodd" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
          ...
          <div className="absolute inset-[18.75%_6.25%]" data-name="Vector">
            <div className="absolute inset-[-10%_-7.14%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 18">
                <path d={svgPaths.p22185f00} id="Vector" stroke="var(--stroke-0, #F7F7F7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="relative shrink-0 size-[24px]" data-name="CheckCircle">
          <div className="absolute inset-[7.81%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.25 20.25">
              <g id="Vector">
                <path d={svgPaths.p2f60c380} fill="var(--fill-0, #F7F7F7)" />
                <path clipRule="evenodd" d={svgPaths.p11fe1580} fill="var(--fill-0, #F7F7F7)" fillRule="evenodd" />
              </g>
            </svg>
          </div>
        </div>
      ...
      <div className="content-stretch flex items-center justify-center p-[6px] relative rounded-[8px] shrink-0" data-name="Header icon">
        <div className="relative shrink-0 size-[24px]" data-name="Question">
          <div className="absolute inset-[7.81%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.25 20.25">
              <g id="Vector">
                <path d={svgPaths.p2d46780} fill="var(--fill-0, #F7F7F7)" />
                <path d={svgPaths.p26053f00} fill="var(--fill-0, #F7F7F7)" />
                <path clipRule="evenodd" d={svgPaths.p2533dd80} fill="var(--fill-0, #F7F7F7)" fillRule="evenodd" />
              </g>
            </svg>
          </div>
        </div>
      ...
      <div className="content-stretch flex gap-[4px] items-center justify-center p-[6px] relative rounded-[8px] shrink-0" data-name="Header icon">
        <div className="relative shrink-0 size-[24px]" data-name="Bell">
          <div className="absolute inset-[7.81%_11.34%_4.69%_11.34%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.5572 21.0002">
              <path clipRule="evenodd" d={svgPaths.p2ecf0eb0} fill="var(--fill-0, #F7F7F7)" fillRule="evenodd" id="Vector" />
            </svg>
          </div>
        </div>
        <div className="relative shrink-0 size-[7px]" data-name="Dot">
          <div className="absolute inset-[-28.57%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
              <circle cx="5.5" cy="5.5" fill="var(--fill-0, #CC2D37)" id="Dot" r="4.5" stroke="var(--stroke-0, white)" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
export default function Component4LogOmpStatistics() {
  return (
    <div className="bg-[#f7f7f7] relative size-full" data-name="4. Log - OMP statistics">
      <PageContent />
      <div className="absolute content-stretch flex flex-col items-start left-0 top-[56px]" data-name="SD-WAN Navigation Menu">
        <div className="content-stretch flex flex-col items-start relative shrink-0 w-[136px]" data-name="SD-WAN Navigation Menu">
          <div className="bg-[#f7f7f7] content-stretch flex flex-col h-[919px] items-start pb-[24px] pt-[16px] relative shrink-0 w-full" data-name="Navigation menu">
            <NavGroups />
          </div>
        </div>
      </div>
      ...
      <div className="absolute bg-[#656c75] h-[165px] left-[1176px] opacity-0 top-[361px] w-[33px]" />
      <div className="absolute bg-[#656c75] h-[34px] left-[1154px] opacity-0 top-[944px] w-[33px]" />
    </div>
  );
}